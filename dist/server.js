...
server.get('/*', function (req, res) {
  ...
  var body = (0, _server.renderToString)(sheet.collectStyles(app));
  var styles = sheet.getStyleTags();
  var title = 'React Server Side Rendering';
  var html = (0, _template2.default)({ body: body, styles: styles, title: title });
  res.send(html);
});
